...
const connectWithUs = [
  ...
  },
  {
    ...
    paragraph:
      "Meet Wakiel, your one-to-one brilliance partner! Unleash your full potential with a dedicated guide who will inspire and support you on your journey to greatness",
    detail:
  ...
  },
  {
    ...
    paragraph:
      "Simplify success with Wakiel, your one-to-one partner! Connect with passionate Wakiels for goal-oriented guidance.",
    detail:
  ...
  },
  {
    ...
    paragraph:
      "Unleash your brilliance with Wakiel, your one-to-one partner! Connect with dedicated brilliance partners for transformative guidance towards success.",
    detail:
  ...
  },
  {
    ...
    paragraph:
      "Transform with Wakiel, your one-to-one brilliance partner! Connect with handpicked brilliance partners dedicated to guiding you towards success.",
    detail:
