...
function HeroSection() {
  return (
    <div id="hero" className="relative min-h-screen bg-gradient-to-br from-dark-bg via-secondary-green to-gray-900 overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-screen">
          ...
          <div className="flex flex-col justify-center space-y-8 text-center lg:text-left">
            ...
            <p className="text-lg lg:text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Access top-notch legal expertise from home. Our platform connects you with skilled attorneys across all practice areas. Browse profiles, read reviews, and schedule consultations
              seamlessly.
            </p>
            ...
            <div className="relative group">
              ...
              <div className="relative w-80 h-80 lg:w-96 lg:h-96 xl:w-[28rem] xl:h-[28rem]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <img src={home} alt="Legal Professional" className="h-80 lg:h-96 xl:h-[28rem] object-contain drop-shadow-2xl transform group-hover:scale-105 transition-all duration-500" />
                </div>
              </div>
