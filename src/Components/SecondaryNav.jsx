    ...
    <div className="bg-gray-900 text-white py-2 px-4 text-sm font-light tracking-wide">
      <div className="max-w-7xl mx-auto flex items-center justify-center">
        <div className="flex items-center space-x-2">
          ...
          <Link to={SecondaryNavbar.link} className="text-primary-green hover:text-accent-gold transition-colors duration-300 font-medium relative group px-2" target="_blank">
          ...
          <img src={SecondaryNavbar.emoji} alt={SecondaryNavbar.appname} className="w-4 h-4" />
